    ...
    <section className="section" aria-labelledby="cta-heading">
      <div className="container">
        <div
          ...
          style={{ padding: 'clamp(2.5rem, 4vw + 1rem, 4.5rem)', alignItems: 'center' }}
        >
          ...
          <p className="lead text-pretty" style={{ maxWidth: '54ch', margin: '0 auto' }}>
            Start with a sector preset, connect the business integrations, and adapt the assistant
            to the way the business actually works.
          </p>
