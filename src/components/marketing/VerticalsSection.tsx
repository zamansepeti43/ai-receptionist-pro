      ...
      <div className="container stack stack-12">
        <div className="stack stack-4" style={{ maxWidth: '52ch' }}>
          ...
          <h2 id="verticals-heading" className="text-balance">
            One core product. Seven starting points.
          </h2>
          <p className="lead">
            Each preset gives the business a useful starting configuration. Services, hours,
            assistant behavior and branding remain editable.
          </p>
        </div>
        <div className="feature-grid stagger-children">
          {VERTICALS.map((v, index) => (
            <Link
              ...
              style={
                { textDecoration: 'none', color: 'inherit', '--i': index } as React.CSSProperties
              }
            >
