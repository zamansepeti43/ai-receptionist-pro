...
const SETTINGS_GROUPS: readonly SettingsGroup[] = [
  {
    title: 'Business',
    description: 'Business identity, language, timezone and operating rules.',
    links: [
  ...
  {
    title: 'Integrations',
    description: 'Connect the communication and scheduling providers used by the business.',
    links: [
  ...
  {
    title: 'AI',
    description: 'Assistant behavior, knowledge and escalation boundaries.',
    links: [
  ...
  },
  {
    ...
    description: 'Plan, billing, privacy and account controls.',
    links: [
    ...
    <>
      <div className="dashboard-header">
        <div className="stack stack-2">
          ...
          <h1>Configure the business</h1>
          <p className="muted">
            Configure the receptionist, integrations and business rules. Items marked as coming soon
            are intentionally disabled rather than linking to placeholder pages.
          </p>
        </div>
      </div>
