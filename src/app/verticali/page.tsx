    ...
    <>
      ...
      <JsonLd
        data={buildCollectionPageSchema({
          name: 'AI Receptionist Pro sector presets',
          description: 'Seven configurable sector starting points.',
          url: '/verticali',
          ...
          <div className="container">
            ...
            >
              ...
              <h1 className="display text-balance">
                One core workflow. A useful starting point for each business.
              </h1>
              <p className="lead text-pretty" style={{ margin: '0 auto' }}>
                Choose a preset to start with sensible messaging and booking boundaries. Every
                business can edit its services, hours, knowledge and assistant behavior.
              </p>
            </div>
            <div
              className="grid"
            ...
            >
              {VERTICALS.map((v) => (
                ...
                >
                  ...
                  >
                    Explore preset <span aria-hidden="true">→</span>
                  </span>
                </Link>
              ))}
            </div>
